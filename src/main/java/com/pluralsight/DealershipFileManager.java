...
public class DealershipFileManager {
    ...
    public Dealership getDealership() {
        ...
        try {
            ...
            if ((headerLine = bReader.readLine()) != null) {
            ...
            ///Parsing vehicle information and Storing into vehicle object
            String vehicleInfo;
    ...
    ///Writing header and getting all vehicles and writes them into csv file
